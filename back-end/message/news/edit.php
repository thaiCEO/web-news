  ...
  <div class="modal-dialog" style=" max-width:70%;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" id="formUpdateNews" enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-8">
              <div class="form-group">
                <label for="">Title</label>
                <input type="text" name="content_id" class="content_id">
            ...
            <div class="col-md-4">
              ...
              <div class="form-group mt-3">
                  ...
                  <i onclick="upload_image('#formUpdateNews')" class="bi bi-plus-circle-fill btn_upload"></i>
      ...
      <div class="modal-footer">
        ...
        <button onclick="updateNews ('#formUpdateNews');" type="button" class="btn btn-success">Save</button>
      </div>
    </div>
  </div>
</div>